...
class Config:
  ...
  if ENV:
    ...
    BOT_TOKEN = '5214623083:AAEv3n_JwfZ7IuAWke-LXChBY1DjMfSj9Dg"

' # Get it from https://t.me/BotFather
    APP_ID = '968661912' # Get it from my.telegram.org/apps
    API_HASH = '813ed33e5b46c49b1a40e5a946a9728d' # Get it from my.telegram.org/apps
